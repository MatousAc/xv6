...
int main(int argc, char *argv[]){
  ...
  35:	68 10 0a 00 00       	push   $0xa10
  3a:	e8 01 06 00 00       	call   640 <printf>
  3f:	83 c4 10             	add    $0x10,%esp
  42:	eb e9                	jmp    2d <main+0x2d>
        printf("Hey, this assignment is due on January 19. If that's today and you don't have it done, finish it!\nRemember that no one gets anywhere without putting forth the effort.\n");
  44:	83 ec 0c             	sub    $0xc,%esp
  47:	68 e8 07 00 00       	push   $0x7e8
...
00000360 <printint.constprop.1>:
 ...
 38f:	f7 f6                	div    %esi
 391:	0f b6 92 2c 0a 00 00 	movzbl 0xa2c(%edx),%edx
...
000003f0 <vprintf.constprop.0>:
 ...
 58b:	6a 01                	push   $0x1
 58d:	0f b6 80 2c 0a 00 00 	movzbl 0xa2c(%eax),%eax
 ...
 614:	bf 25 0a 00 00       	mov    $0xa25,%edi
...
free(void *ap)
{
 ...
 661:	a1 10 0d 00 00       	mov    0xd10,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 10 0d 00 00       	mov    %eax,0xd10
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
 ...
 6b6:	72 ce                	jb     686 <free+0x26>
{
 ...
 6d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6da:	a3 10 0d 00 00       	mov    %eax,0xd10
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 15 10 0d 00 00    	mov    0xd10,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 47                	jae    788 <malloc+0x98>
    ...
    if(p == freep)
 741:	39 05 10 0d 00 00    	cmp    %eax,0xd10
 ...
 766:	e8 f5 fe ff ff       	call   660 <free>
  return freep;
 76b:	8b 15 10 0d 00 00    	mov    0xd10,%edx
 ...
 794:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 797:	89 15 10 0d 00 00    	mov    %edx,0xd10
}
 ...
 7a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 10 0d 00 00 14 	movl   $0xd14,0xd10
 7b7:	0d 00 00 
 7ba:	c7 05 14 0d 00 00 14 	movl   $0xd14,0xd14
 7c1:	0d 00 00 
    base.s.size = 0;
 7c4:	b8 14 0d 00 00       	mov    $0xd14,%eax
 7c9:	c7 05 18 0d 00 00 00 	movl   $0x0,0xd18
 7d0:	00 00 00 
