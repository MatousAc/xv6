...
int main(int argc, char *argv[]){
  ...
  35:	68 20 0a 00 00       	push   $0xa20
  3a:	e8 11 06 00 00       	call   650 <printf>
  3f:	83 c4 10             	add    $0x10,%esp
  42:	eb e9                	jmp    2d <main+0x2d>
        printf("Hey, this assignment is due on January 19. If that's today and you don't have it done, finish it!\nRemember that no one gets anywhere without putting forth the effort.\n");
  44:	83 ec 0c             	sub    $0xc,%esp
  47:	68 f8 07 00 00       	push   $0x7f8
  4c:	e8 ff 05 00 00       	call   650 <printf>
  51:	83 c4 10             	add    $0x10,%esp
  54:	eb d7                	jmp    2d <main+0x2d>
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
  5c:	66 90                	xchg   %ax,%ax
...
00000370 <printint.constprop.1>:
 ...
 39f:	f7 f6                	div    %esi
 3a1:	0f b6 92 3c 0a 00 00 	movzbl 0xa3c(%edx),%edx
...
00000400 <vprintf.constprop.0>:
 ...
 59b:	6a 01                	push   $0x1
 59d:	0f b6 80 3c 0a 00 00 	movzbl 0xa3c(%eax),%eax
 ...
 624:	bf 35 0a 00 00       	mov    $0xa35,%edi
...
free(void *ap)
{
 ...
 671:	a1 20 0d 00 00       	mov    0xd20,%eax
{
 ...
 6ad:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6af:	a3 20 0d 00 00       	mov    %eax,0xd20
}
 6b4:	5b                   	pop    %ebx
 6b5:	5e                   	pop    %esi
 6b6:	5f                   	pop    %edi
 ...
 6c6:	72 ce                	jb     696 <free+0x26>
{
 ...
 6e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ea:	a3 20 0d 00 00       	mov    %eax,0xd20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 15 20 0d 00 00    	mov    0xd20,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 47                	jae    798 <malloc+0x98>
    ...
    if(p == freep)
 751:	39 05 20 0d 00 00    	cmp    %eax,0xd20
 ...
 776:	e8 f5 fe ff ff       	call   670 <free>
  return freep;
 77b:	8b 15 20 0d 00 00    	mov    0xd20,%edx
 ...
 7a4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7a7:	89 15 20 0d 00 00    	mov    %edx,0xd20
}
 ...
 7b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 20 0d 00 00 24 	movl   $0xd24,0xd20
 7c7:	0d 00 00 
 7ca:	c7 05 24 0d 00 00 24 	movl   $0xd24,0xd24
 7d1:	0d 00 00 
    base.s.size = 0;
 7d4:	b8 24 0d 00 00       	mov    $0xd24,%eax
 7d9:	c7 05 28 0d 00 00 00 	movl   $0x0,0xd28
 7e0:	00 00 00 
