...
user/_tryfork:     file format elf32-i386
...
int main(int argc, const char* argv[]) {
  ...
  printf("My pid is %d\n", getpid());
  11:	e8 3c 03 00 00       	call   352 <getpid>
  16:	83 ec 08             	sub    $0x8,%esp
  19:	50                   	push   %eax
  1a:	68 08 08 00 00       	push   $0x808
  1f:	e8 3c 06 00 00       	call   660 <printf>
  int child_pid = fork();
  24:	e8 a1 02 00 00       	call   2ca <fork>
  if (child_pid < 0) {
  29:	83 c4 10             	add    $0x10,%esp
  2c:	85 c0                	test   %eax,%eax
  2e:	78 38                	js     68 <main+0x68>
    printf("fork failed\n");
  } else if (child_pid == 0) {
  30:	74 1f                	je     51 <main+0x51>
    printf("this is child. pid: %d\n", getpid());
  } else {
    wait();
  32:	e8 a3 02 00 00       	call   2da <wait>
    printf("this is parent. pid: %d", getpid());
  37:	e8 16 03 00 00       	call   352 <getpid>
  3c:	52                   	push   %edx
  3d:	52                   	push   %edx
  3e:	50                   	push   %eax
  3f:	68 3b 08 00 00       	push   $0x83b
  44:	e8 17 06 00 00       	call   660 <printf>
  49:	83 c4 10             	add    $0x10,%esp
  }
  exit();
  4c:	e8 81 02 00 00       	call   2d2 <exit>
    printf("this is child. pid: %d\n", getpid());
  51:	e8 fc 02 00 00       	call   352 <getpid>
  56:	51                   	push   %ecx
  57:	51                   	push   %ecx
  58:	50                   	push   %eax
  59:	68 23 08 00 00       	push   $0x823
  5e:	e8 fd 05 00 00       	call   660 <printf>
  63:	83 c4 10             	add    $0x10,%esp
  66:	eb e4                	jmp    4c <main+0x4c>
    printf("fork failed\n");
  68:	83 ec 0c             	sub    $0xc,%esp
  6b:	68 16 08 00 00       	push   $0x816
  70:	e8 eb 05 00 00       	call   660 <printf>
...
00000410 <vprintf.constprop.0>:
 ...
 5ab:	6a 01                	push   $0x1
 5ad:	0f b6 80 5c 08 00 00 	movzbl 0x85c(%eax),%eax
 ...
 634:	bf 53 08 00 00       	mov    $0x853,%edi
