...
main(int argc, char **argv)
{
  ...
  50:	6a 02                	push   $0x2
  52:	e8 c9 05 00 00       	call   620 <fprintf>
    exit();
...
00000360 <printint.constprop.1>:
 ...
 38f:	f7 f6                	div    %esi
 391:	0f b6 92 04 08 00 00 	movzbl 0x804(%edx),%edx
...
000003f0 <vprintf.constprop.0>:
 ...
 58b:	6a 01                	push   $0x1
 58d:	0f b6 80 04 08 00 00 	movzbl 0x804(%eax),%eax
 ...
 614:	bf fc 07 00 00       	mov    $0x7fc,%edi
