...
00000000 <main>:
  ...
  58:	6a 02                	push   $0x2
  5a:	e8 f1 05 00 00       	call   650 <fprintf>
  ...
  6b:	6a 02                	push   $0x2
  6d:	e8 de 05 00 00       	call   650 <fprintf>
...
00000390 <printint.constprop.1>:
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 54 08 00 00 	movzbl 0x854(%edx),%edx
...
00000420 <vprintf.constprop.0>:
 ...
 5bb:	6a 01                	push   $0x1
 5bd:	0f b6 80 54 08 00 00 	movzbl 0x854(%eax),%eax
 ...
 644:	bf 4b 08 00 00       	mov    $0x84b,%edi
...
free(void *ap)
{
 ...
 691:	a1 44 0b 00 00       	mov    0xb44,%eax
{
 ...
 6cd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6cf:	a3 44 0b 00 00       	mov    %eax,0xb44
}
 6d4:	5b                   	pop    %ebx
 6d5:	5e                   	pop    %esi
 6d6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 15 44 0b 00 00    	mov    0xb44,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 47                	jae    7b8 <malloc+0x98>
    ...
    if(p == freep)
 771:	39 05 44 0b 00 00    	cmp    %eax,0xb44
 ...
 796:	e8 f5 fe ff ff       	call   690 <free>
  return freep;
 79b:	8b 15 44 0b 00 00    	mov    0xb44,%edx
 ...
 7c4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7c7:	89 15 44 0b 00 00    	mov    %edx,0xb44
}
 ...
 7d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 44 0b 00 00 48 	movl   $0xb48,0xb44
 7e7:	0b 00 00 
 7ea:	c7 05 48 0b 00 00 48 	movl   $0xb48,0xb48
 7f1:	0b 00 00 
    base.s.size = 0;
 7f4:	b8 48 0b 00 00       	mov    $0xb48,%eax
 7f9:	c7 05 4c 0b 00 00 00 	movl   $0x0,0xb4c
 800:	00 00 00 
