...
00000150 <panic>:
{
  ...
  fprintf(2, "%s\n", s);
     ...
     159:	68 e5 12 00 00       	push   $0x12e5
     15e:	6a 02                	push   $0x2
...
00000170 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1a9:	68 52 12 00 00       	push   $0x1252
     1ae:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     1fd:	68 62 12 00 00       	push   $0x1262
     202:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     ...
     290:	68 4b 12 00 00       	push   $0x124b
     295:	e8 b6 fe ff ff       	call   150 <panic>
    panic("fork");
     29a:	83 ec 0c             	sub    $0xc,%esp
     29d:	68 72 12 00 00       	push   $0x1272
     ...
     2d8:	68 77 12 00 00       	push   $0x1277
...
00000310 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     325:	68 72 12 00 00       	push   $0x1272
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     653:	68 99 12 00 00       	push   $0x1299
     658:	53                   	push   %ebx
     659:	56                   	push   %esi
  ...
  return cmd;
     ...
     6de:	68 7c 12 00 00       	push   $0x127c
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     6ff:	68 9c 12 00 00       	push   $0x129c
     704:	57                   	push   %edi
     705:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     74e:	68 b3 12 00 00       	push   $0x12b3
     753:	57                   	push   %edi
     754:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     798:	68 a5 12 00 00       	push   $0x12a5
  ...
  cmd->eargv[argc] = 0;
     ...
     7ea:	68 9e 12 00 00       	push   $0x129e
...
00000800 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     81b:	68 b8 12 00 00       	push   $0x12b8
     820:	56                   	push   %esi
     821:	53                   	push   %ebx
...
00000870 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     8ab:	68 ba 12 00 00       	push   $0x12ba
     8b0:	56                   	push   %esi
     8b1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8c1:	68 b6 12 00 00       	push   $0x12b6
     8c6:	56                   	push   %esi
     8c7:	53                   	push   %ebx
...
00000910 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     91f:	68 9c 12 00 00       	push   $0x129c
     924:	56                   	push   %esi
     925:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     94b:	68 d8 12 00 00       	push   $0x12d8
     950:	56                   	push   %esi
     951:	53                   	push   %ebx
...
00000a50 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a77:	68 61 12 00 00       	push   $0x1261
     a7c:	53                   	push   %ebx
     a7d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     a9f:	52                   	push   %edx
     aa0:	50                   	push   %eax
     aa1:	68 da 12 00 00       	push   $0x12da
     aa6:	6a 02                	push   $0x2
     aa8:	e8 d3 05 00 00       	call   1080 <fprintf>
    panic("syntax");
     aad:	c7 04 24 9e 12 00 00 	movl   $0x129e,(%esp)
