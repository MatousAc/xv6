...
printint(int fd, int xx, int base, int sgn)
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 4c 08 00 00 	movzbl 0x84c(%edx),%edx
  }while((x /= base) != 0);
 ...
 428:	83 ec 2c             	sub    $0x2c,%esp
{
 ...
 5b8:	c1 e8 1c             	shr    $0x1c,%eax
  write(fd, &c, 1);
 5bb:	6a 01                	push   $0x1
 5bd:	0f b6 80 4c 08 00 00 	movzbl 0x84c(%eax),%eax
 ...
 63f:	e9 1b fe ff ff       	jmp    45f <vprintf.constprop.0+0x3f>
          s = "(null)";
 644:	bf 45 08 00 00       	mov    $0x845,%edi
        while(*s != 0){
 ...
 691:	a1 3c 0b 00 00       	mov    0xb3c,%eax
{
 ...
 6cd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6cf:	a3 3c 0b 00 00       	mov    %eax,0xb3c
}
 6d4:	5b                   	pop    %ebx
 6d5:	5e                   	pop    %esi
 6d6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 15 3c 0b 00 00    	mov    0xb3c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 47                	jae    7b8 <malloc+0x98>
    ...
    if(p == freep)
 771:	39 05 3c 0b 00 00    	cmp    %eax,0xb3c
 ...
 796:	e8 f5 fe ff ff       	call   690 <free>
  return freep;
 79b:	8b 15 3c 0b 00 00    	mov    0xb3c,%edx
 ...
 7c4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7c7:	89 15 3c 0b 00 00    	mov    %edx,0xb3c
}
 ...
 7d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 3c 0b 00 00 40 	movl   $0xb40,0xb3c
 7e7:	0b 00 00 
 7ea:	c7 05 40 0b 00 00 40 	movl   $0xb40,0xb40
 7f1:	0b 00 00 
    base.s.size = 0;
 7f4:	b8 40 0b 00 00       	mov    $0xb40,%eax
 7f9:	c7 05 44 0b 00 00 00 	movl   $0x0,0xb44
 800:	00 00 00 
