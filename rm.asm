...
00000380 <printint.constprop.1>:
 ...
 3af:	f7 f6                	div    %esi
 3b1:	0f b6 92 3c 08 00 00 	movzbl 0x83c(%edx),%edx
...
00000410 <vprintf.constprop.0>:
 ...
 5ab:	6a 01                	push   $0x1
 5ad:	0f b6 80 3c 08 00 00 	movzbl 0x83c(%eax),%eax
 ...
 634:	bf 35 08 00 00       	mov    $0x835,%edi
 ...
 681:	a1 2c 0b 00 00       	mov    0xb2c,%eax
{
 ...
 6bd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6bf:	a3 2c 0b 00 00       	mov    %eax,0xb2c
}
 6c4:	5b                   	pop    %ebx
 6c5:	5e                   	pop    %esi
 6c6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 15 2c 0b 00 00    	mov    0xb2c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 47                	jae    7a8 <malloc+0x98>
    ...
    if(p == freep)
 761:	39 05 2c 0b 00 00    	cmp    %eax,0xb2c
 ...
 786:	e8 f5 fe ff ff       	call   680 <free>
  return freep;
 78b:	8b 15 2c 0b 00 00    	mov    0xb2c,%edx
 ...
 7b4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7b7:	89 15 2c 0b 00 00    	mov    %edx,0xb2c
}
 ...
 7c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 2c 0b 00 00 30 	movl   $0xb30,0xb2c
 7d7:	0b 00 00 
 7da:	c7 05 30 0b 00 00 30 	movl   $0xb30,0xb30
 7e1:	0b 00 00 
    base.s.size = 0;
 7e4:	b8 30 0b 00 00       	mov    $0xb30,%eax
 7e9:	c7 05 34 0b 00 00 00 	movl   $0x0,0xb34
 7f0:	00 00 00 
