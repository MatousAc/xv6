...
80103c24:	8d 5e 2c             	lea    0x2c(%esi),%ebx
80103c27:	8d 7e 6c             	lea    0x6c(%esi),%edi
...
80103eec:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103ef3:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
...
80104069:	8d 43 70             	lea    0x70(%ebx),%eax
...
80104878:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104879:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
...
801049d4:	68 38 76 10 80       	push   $0x80107638
...
801049ec:	68 37 76 10 80       	push   $0x80107637
...
80104a05:	68 2b 76 10 80       	push   $0x8010762b
...
80104a1a:	68 3a 76 10 80       	push   $0x8010763a
80104a1f:	e8 6c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a24:	83 ec 0c             	sub    $0xc,%esp
80104a27:	68 1c 76 10 80       	push   $0x8010761c
...
80104a6c:	8b 44 90 2c          	mov    0x2c(%eax,%edx,4),%eax
...
80104ac0:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
80104ac4:	85 d2                	test   %edx,%edx
80104ac6:	75 f0                	jne    80104ab8 <sys_dup+0x28>
      curproc->ofile[fd] = f;
80104ac8:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
...
80104bfd:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104c00:	c7 44 90 2c 00 00 00 	movl   $0x0,0x2c(%eax,%edx,4)
80104c07:	00 
  fileclose(f);
...
80104e19:	58                   	pop    %eax
80104e1a:	5a                   	pop    %edx
80104e1b:	68 38 76 10 80       	push   $0x80107638
...
80104e34:	68 37 76 10 80       	push   $0x80107637
...
80105046:	0f 84 ac 00 00 00    	je     801050f8 <sys_open+0x148>
    if(curproc->ofile[fd] == 0){
8010504c:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
80105054:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80105057:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
...
8010541e:	74 28                	je     80105448 <sys_pipe+0xa8>
    if(curproc->ofile[fd] == 0){
80105420:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
80105424:	85 c9                	test   %ecx,%ecx
80105426:	75 f0                	jne    80105418 <sys_pipe+0x78>
      curproc->ofile[fd] = f;
80105428:	89 7c 90 2c          	mov    %edi,0x2c(%eax,%edx,4)
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
8010544d:	c7 44 b0 0c 00 00 00 	movl   $0x0,0xc(%eax,%esi,4)
80105454:	00 
...
80105687:	c7 04 c5 a2 4d 11 80 	movl   $0x8e000008,-0x7feeb25e(,%eax,8)
8010568e:	08 00 00 8e 
80105692:	66 89 14 c5 a0 4d 11 	mov    %dx,-0x7feeb260(,%eax,8)
80105699:	80 
8010569a:	c1 ea 10             	shr    $0x10,%edx
8010569d:	66 89 14 c5 a6 4d 11 	mov    %dx,-0x7feeb25a(,%eax,8)
801056a4:	80 
  for(i = 0; i < 256; i++)
...
801056b4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056b7:	c7 05 a2 4f 11 80 08 	movl   $0xef000008,0x80114fa2
801056be:	00 00 ef 
  initlock(&tickslock, "time");
801056c1:	68 7d 76 10 80       	push   $0x8010767d
801056c6:	68 60 4d 11 80       	push   $0x80114d60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056cb:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
801056d1:	c1 e8 10             	shr    $0x10,%eax
801056d4:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
...
801056fb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801056ff:	b8 a0 4d 11 80       	mov    $0x80114da0,%eax
...
8010579d:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
8010579e:	83 c2 70             	add    $0x70,%edx
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80106cbb:	a3 a4 55 11 80       	mov    %eax,0x801155a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
