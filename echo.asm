...
00000000 <main>:
  ...
  23:	eb 19                	jmp    3e <main+0x3e>
  25:	8d 76 00             	lea    0x0(%esi),%esi
  28:	83 ec 04             	sub    $0x4,%esp
  2b:	68 f8 07 00 00       	push   $0x7f8
  30:	50                   	push   %eax
  31:	68 fa 07 00 00       	push   $0x7fa
  36:	e8 15 06 00 00       	call   650 <printf>
  3b:	83 c4 10             	add    $0x10,%esp
  3e:	83 c3 04             	add    $0x4,%ebx
  41:	8b 43 fc             	mov    -0x4(%ebx),%eax
  44:	39 f3                	cmp    %esi,%ebx
  46:	75 e0                	jne    28 <main+0x28>
  48:	52                   	push   %edx
  49:	68 ff 07 00 00       	push   $0x7ff
  4e:	50                   	push   %eax
  4f:	68 fa 07 00 00       	push   $0x7fa
  54:	e8 f7 05 00 00       	call   650 <printf>
...
00000370 <printint.constprop.1>:
 ...
 39f:	f7 f6                	div    %esi
 3a1:	0f b6 92 08 08 00 00 	movzbl 0x808(%edx),%edx
...
00000400 <vprintf.constprop.0>:
 ...
 59b:	6a 01                	push   $0x1
 59d:	0f b6 80 08 08 00 00 	movzbl 0x808(%eax),%eax
 ...
 624:	bf 01 08 00 00       	mov    $0x801,%edi
