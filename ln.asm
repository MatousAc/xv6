   ...
   7:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  1e:	6a 02                	push   $0x2
  20:	e8 0b 06 00 00       	call   630 <fprintf>
    exit();
  ...
  4e:	6a 02                	push   $0x2
  50:	e8 db 05 00 00       	call   630 <fprintf>
...
printint(int fd, int xx, int base, int sgn)
 ...
 39f:	f7 f6                	div    %esi
 3a1:	0f b6 92 28 08 00 00 	movzbl 0x828(%edx),%edx
  }while((x /= base) != 0);
 ...
 408:	83 ec 2c             	sub    $0x2c,%esp
{
 ...
 598:	c1 e8 1c             	shr    $0x1c,%eax
  write(fd, &c, 1);
 59b:	6a 01                	push   $0x1
 59d:	0f b6 80 28 08 00 00 	movzbl 0x828(%eax),%eax
 ...
 61f:	e9 1b fe ff ff       	jmp    43f <vprintf.constprop.0+0x3f>
          s = "(null)";
 624:	bf 1f 08 00 00       	mov    $0x81f,%edi
        while(*s != 0){
