...
00000000 <main>:
  ...
  1e:	6a 02                	push   $0x2
  20:	e8 fb 05 00 00       	call   620 <fprintf>
  ...
  4e:	6a 02                	push   $0x2
  50:	e8 cb 05 00 00       	call   620 <fprintf>
...
00000360 <printint.constprop.1>:
 ...
 38f:	f7 f6                	div    %esi
 391:	0f b6 92 18 08 00 00 	movzbl 0x818(%edx),%edx
...
000003f0 <vprintf.constprop.0>:
 ...
 58b:	6a 01                	push   $0x1
 58d:	0f b6 80 18 08 00 00 	movzbl 0x818(%eax),%eax
 ...
 614:	bf 0f 08 00 00       	mov    $0x80f,%edi
 ...
 661:	a1 00 0b 00 00       	mov    0xb00,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 00 0b 00 00       	mov    %eax,0xb00
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 73f:	73 47                	jae    788 <malloc+0x98>
    ...
    if(p == freep)
 741:	39 05 00 0b 00 00    	cmp    %eax,0xb00
 ...
 766:	e8 f5 fe ff ff       	call   660 <free>
  return freep;
 76b:	8b 15 00 0b 00 00    	mov    0xb00,%edx
 ...
 794:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 797:	89 15 00 0b 00 00    	mov    %edx,0xb00
}
 ...
 7a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 00 0b 00 00 04 	movl   $0xb04,0xb00
 7b7:	0b 00 00 
 7ba:	c7 05 04 0b 00 00 04 	movl   $0xb04,0xb04
 7c1:	0b 00 00 
    base.s.size = 0;
 7c4:	b8 04 0b 00 00       	mov    $0xb04,%eax
 7c9:	c7 05 08 0b 00 00 00 	movl   $0x0,0xb08
 7d0:	00 00 00 
